...
func TestHandleCER_Acct_Fail(t *testing.T) {
	...
	mustSMClientAVP(t, m, avp.ProductName, 0, 0, clientSettings.ProductName)
	mustSMClientAVP(t, m, avp.OriginStateID, avp.Mbit, 0, datatype.Unsigned32(1))
	mustSMClientAVP(t, m, avp.AcctApplicationID, avp.Mbit, 0, datatype.Unsigned32(1000))
	mustSMClientAVP(t, m, avp.FirmwareRevision, 0, 0, clientSettings.FirmwareRevision)
	_, err = m.WriteTo(cli)
	if err != nil {
		t.Fatal(err)
...
func TestHandleCER_VS_Acct(t *testing.T) {
	...
	mustSMClientAVP(t, m, avp.ProductName, 0, 0, clientSettings.ProductName)
	mustSMClientAVP(t, m, avp.OriginStateID, avp.Mbit, 0, datatype.Unsigned32(1))
	mustSMClientAVP(t, m, avp.VendorSpecificApplicationID, avp.Mbit, 0, &diam.GroupedAVP{
		AVP: []*diam.AVP{
...
func TestHandleCER_Auth(t *testing.T) {
	...
	mustSMClientAVP(t, m, avp.ProductName, 0, 0, clientSettings.ProductName)
	mustSMClientAVP(t, m, avp.OriginStateID, avp.Mbit, 0, datatype.Unsigned32(1))
	mustSMClientAVP(t, m, avp.AuthApplicationID, avp.Mbit, 0, datatype.Unsigned32(1002))
	mustSMClientAVP(t, m, avp.FirmwareRevision, 0, 0, clientSettings.FirmwareRevision)
	_, err = m.WriteTo(cli)
	if err != nil {
		t.Fatal(err)
...
func TestHandleCER_Auth_Fail(t *testing.T) {
	...
	mustSMClientAVP(t, m, avp.ProductName, 0, 0, clientSettings.ProductName)
	mustSMClientAVP(t, m, avp.OriginStateID, avp.Mbit, 0, datatype.Unsigned32(1))
	mustSMClientAVP(t, m, avp.AuthApplicationID, avp.Mbit, 0, datatype.Unsigned32(1000))
	mustSMClientAVP(t, m, avp.FirmwareRevision, 0, 0, clientSettings.FirmwareRevision)
	_, err = m.WriteTo(cli)
	if err != nil {
		t.Fatal(err)
...
func TestHandleCER_InbandSecurity(t *testing.T) {
	...
	mustSMClientAVP(t, m, avp.OriginRealm, avp.Mbit, 0, clientSettings.OriginRealm)
	mustSMClientAVP(t, m, avp.HostIPAddress, avp.Mbit, 0, localhostAddress)
	mustSMClientAVP(t, m, avp.InbandSecurityID, avp.Mbit, 0, datatype.Unsigned32(1))
	mustSMClientAVP(t, m, avp.VendorID, avp.Mbit, 0, clientSettings.VendorID)
	mustSMClientAVP(t, m, avp.ProductName, 0, 0, clientSettings.ProductName)
	mustSMClientAVP(t, m, avp.OriginStateID, avp.Mbit, 0, datatype.Unsigned32(1))
	mustSMClientAVP(t, m, avp.FirmwareRevision, 0, 0, clientSettings.FirmwareRevision)
