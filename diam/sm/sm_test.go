...
func testStateMachine(t *testing.T, network string) {
	...
	mustSMClientAVP(t, m, avp.SessionID, avp.Mbit, 0, datatype.OctetString("foobar"))
	mustSMClientAVP(t, m, avp.OriginHost, avp.Mbit, 0, clientSettings.OriginHost)
	mustSMClientAVP(t, m, avp.OriginRealm, avp.Mbit, 0, clientSettings.OriginRealm)
	mustSMClientAVP(t, m, avp.AuthApplicationID, avp.Mbit, 0, datatype.Unsigned32(1002))
	mustSMClientAVP(t, m, avp.ReAuthRequestType, avp.Mbit, 0, datatype.Unsigned32(0))
	mustSMClientAVP(t, m, avp.UserName, avp.Mbit, 0, datatype.OctetString("test"))
	mustSMClientAVP(t, m, avp.OriginStateID, avp.Mbit, 0, datatype.Unsigned32(1))
	_, err = m.WriteTo(cli)
	if err != nil {
		t.Fatal(err)
