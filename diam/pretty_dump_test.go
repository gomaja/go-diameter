...
func TestPrettyDump(t *testing.T) {
	...
	mustPrettyAVP(t, msg, avp.CCRequestType, avp.Mbit, 0, datatype.Enumerated(1))
	mustPrettyAVP(t, msg, avp.CCRequestNumber, avp.Mbit, 0, datatype.Unsigned32(1000))
	mustPrettyAVP(t, msg, avp.MultipleServicesCreditControl, avp.Mbit, 0, &GroupedAVP{
		AVP: []*AVP{
	...
	mustPrettyAVP(t, msg, avp.ServiceInformation, avp.Mbit, 10415, &GroupedAVP{
		AVP: []*AVP{
